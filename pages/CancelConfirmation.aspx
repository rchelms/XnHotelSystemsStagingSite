<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
     CodeFile="CancelConfirmation.aspx.cs" Inherits="CancelConfirmation"
...
<%@ Reference Control="~/controls/CancelBookingSummaryControl.1.ascx" %>
<%@ Reference Control="~/controls/TrackingCodeControl.1.ascx" %>
<%@ Reference Control="~/controls/TrackingCodeItemControl.1.ascx" %>
<asp:Content ID="cpgCancelConfirmation" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:Panel runat="server">
        ...
        <asp:Panel CssClass="content_section" runat="server">
            ...
            <asp:Panel CssClass="pane_body" runat="server">
                <h3>
                    <asp:Label ID="lblCancelConfirmation" runat="server" Text="" meta:resourcekey="lblCancelConfirmation" /></h3>
                <p>
                    <asp:Label ID="lblCancelConfirmationComments" runat="server" Text="" meta:resourcekey="lblCancelConfirmationComments" /></p>
            </asp:Panel>
        </asp:Panel>
        <asp:Panel runat="server">
        ...
        <asp:Panel runat="server">
            <asp:PlaceHolder ID="phCancelBookingSummaryControl" runat="server" />
        </asp:Panel>
    </asp:Panel>
