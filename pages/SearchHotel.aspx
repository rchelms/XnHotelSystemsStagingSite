<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
     CodeFile="SearchHotel.aspx.cs" Inherits="SearchHotel" Title="Search Hotel" %>
    ...
    <asp:Panel runat="server">
        ...
        <asp:Panel CssClass="content_section" runat="server">
            ...
            <asp:Panel CssClass="pane_body" runat="server">
                <h3>
                    <asp:Label ID="lblSearchHotel" runat="server" Text="" meta:resourcekey="lblSearchHotel" /></h3>
                <p>
                    <asp:Label ID="lblSearchHotelInstructions" runat="server" Text="" meta:resourcekey="lblSearchHotelInstructions" /></p>
            </asp:Panel>
        </asp:Panel>
        <asp:Panel runat="server">
